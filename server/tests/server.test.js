...
describe ('GET /todos', () => {
  it('should get all todos', (done) => {
    request(app)
      ...
      .expect(200)
      .expect((res) => {
        expect(res.body.todos.length).toBe(1); // changed from 2 to 1 with x-auth are good
      })
      .end(done);
  });
});
...
describe('DELETE /todos/:id', () => {
  ...
  it('should not remove a todo we dont own', (done) => {
...
describe('PATCH /todos/:id', () => {
  ...
  it ('should not update first todo as second user', (done) => {
    var hexId = todos[0]._id.toHexString();
    var text = 'This should be the new text';
